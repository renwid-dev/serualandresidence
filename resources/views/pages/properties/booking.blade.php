	                    	...
	                    	<div class="properties-box">
	                    		<div class="inner-container">
	                    			<div class="property-submit-form">
										<form method="POST" action="{{ route('user/booking/list') }}" enctype="multipart/form-data">
										@csrf
										<input type="text" name="{{ $property->id }}" value="{{ $property->id }}" hidden>
										<input type="text" name="{{ $property->title }}" value="{{ $property->title }}" hidden>
										<input type="text" name="{{ number_format($property->price,2) }}" value="{{ number_format($property->price,2) }}" hidden>
