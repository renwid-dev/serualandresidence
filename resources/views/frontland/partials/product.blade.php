                ...
                <div class="inner-box">
                    <div class="image-box">
                        ...
                        <ul class="info clearfix">
                            ...
                            <li><a href="{{route('properties')}}"><i class="la la-user-secret"></i>Ghaly Morca</a></li>
                        </ul>
                    </div>
                    <div class="lower-content">
                        <ul class="tags">
                            <li><a href="{{route('properties')}}">Apartment</a>,</li>
                            <li><a href="{{route('properties')}}">Bar</a>,</li>
                            <li><a href="{{route('properties')}}">House</a>,</li>
                        </ul>
                        <h3><a href="{{route('properties')}}">Single House Near Orland Park.</a></h3>
                        ...
                        <div class="property-price clearfix">
                            <div class="read-more"><a href="{{route('properties')}}" class="theme-btn">More Detail</a></div>
            ...
            <div class="property-block col-lg-4 col-md-6 col-sm-12">
                <div class="inner-box">
                    <div class="image-box">
                        ...
                        <span class="featured">FEATURED</span>
                        <ul class="option-box">
                            <li><a href="{{ asset('images/resource/property-1.jpg') }}" class="lightbox-image" data-fancybox="property"><i class="la la-camera"></i></a></li>
                            <li><a href="{{route('properties')}}"><i class="la la-heart"></i></a></li>
                            <li><a href="{{route('properties')}}"><i class="la la-retweet"></i></a></li>
                        </ul>
                        <ul class="info clearfix">
                            <li><a href="properties.html"><i class="la la-calendar-minus-o"></i>2 Years Ago</a></li>
                            <li><a href="{{route('properties')}}"><i class="la la-user-secret"></i>Ghaly Morca</a></li>
                    ...
                    <div class="lower-content">
                        ...
                        <h3><a href="{{route('properties')}}">Apartment Morden 1243, W No.</a></h3>
                        <div class="lucation"><i class="la la-map-marker"></i> Orland Park, IL 35785, Chicago, United State</div>
                        <ul class="property-info clearfix">
                            <li><i class="flaticon-dimension"></i> 356 Sq-Ft</li>
                            <li><i class="flaticon-bed"></i> 4 Bedrooms</li>
            ...
            <div class="property-block col-lg-4 col-md-6 col-sm-12">
                <div class="inner-box">
                    ...
                    <div class="lower-content">
                        ...
                        <h3><a href="{{route('properties')}}">Great Home for Single fmaily</a></h3>
                        <div class="lucation"><i class="la la-map-marker"></i> Orland Park, IL 35785, Chicago, United State</div>
                        <ul class="property-info clearfix">
                            <li><i class="flaticon-dimension"></i> 356 Sq-Ft</li>
                            <li><i class="flaticon-bed"></i> 4 Bedrooms</li>
